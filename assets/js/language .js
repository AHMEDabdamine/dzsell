let lang = {
    ar: { 
        ...
        buynow:"تواصل معنا الآن",
        ask:"أيّة أسئلة ؟ ",
        commonask: "أكثر الأسئلة طرحا من طرف زبائننا وإجاباتها ",
        1:"كيف لي أن أنزل وأثبت Dz SELL ",
        a1:"بعد إقتنائك لـ Dz SELL حمل تطبيق rustdesk  وتواصل معنا سنعمل على تجهيز كل شيء من أجلك أو يمكنك الإطلاع على الوثيقة إذا أردت إعداد كل شيء بمفردك",
        2:"ماهي إجابيات استعمال Dz SELL ؟",
        a2:"تكمن إيحابيات استعمال برنامج إدارة البيع الخاص بنا في إبقاء تجارتكم منظمة وأنيقة مع الخصائص العديد لاتباع الأرباح والخسائر وتنظيم المتاجر",
        3:"هل يدعم Dz SELL  استيراد وتصدير المعلومات عن طريق  أكسل ؟ ",
        a3:" شيء أكيد فبرنامجنا مجهز بتقنية استيراد وتصدير المعلومات كالزبائن والسلع وغير ذلك وكذلك يدعم صيغ عديدة عند تصدير المعلومات كـ PDF و xlsx و sql    ",
        4:"هل يتوافق Dz SELL مع مختلف أنواع الماسحات الضوئية والطابعات ",
        a4:"نعم ، نظام Dz SELL يتوافق مع معظم أو يمكن القول جميع أنواع الماسحات الضوئية والطابعات الحبرية منها أو الحرارية .",
        5:"كيف يمكنني ضبط Dz SELL ليتوافق مع ميزان الباركود ؟",
        a5:"يمكن ضبط هذا من خلال الإعدادات الخاصة بالباركود حيث يمكنك اختيار نوع الباركود المطبوع من طرف الميزان الذكي وبعدها إنشاء صيغة إدخال جديدة . تم شرح هذا أيضا في الوثيقة ودليل الإستعمال الخاص بـئ Dz SELL ",
        6 :"ماذا يتسعمل Dz SELL كقاعدة بيانات ؟", 
        a6:"يستند Dz SELL على قاعد بيانات MYSQL التي يتم توفيرها من طرف برنامج WAMP server , تتمتع هذه الأخيرة بعدة خصائص مثل النسخ الإحتياطي لقاعدة البيانات وغيرها ", 
        meettm:"قابل الفريق ", 
        hamed:"عبد السلام أحمد ",
        dev : "مطور ويب  ", 
        sp:" الدعم", 
        terms :"سياسة الخدمة ",    
        ...
        pre:"  المتطلبات اللازمة لتشغيل Dz SELL  ",
           ...
           dzs:"2- اقتني Dz SELL وحمله ",
           or1:"قم بشراء Dz SELL من موقعنا أو ",
           or2:"وتحصل على رابط التحميل .",
           Extract:"3 - فك الضغط عن المتطلبات ",
           ect:"فك  الضغط عن محتوى الملف المحمل سابقا  سيصبح لديك ملفين ",
           cinst:"4 - تثبيت حزمة C++ ",
           isn:"استخرج الحزمة  وابحث عن ملف  'install_all.bat'. قم بتشغيل هذا الملف وانتظر حتى يكتمل التثبيت. وافق على جميع المطالبات التي تظهر أثناء التثبيت. لا تقلق إذا رأيت موجه أوامر، فهذا أمر طبيعي.",
           wampinst:" 5- تثبيت WAMP server ",
           wampp:"قم بتشغيل Wamp server.exe واتبع الخطوات التالية في تثبيته :",
            s1:"اختر لغتك وانقر على 'موافق'",
            s2:"وافق على شروط الاستخدام وانقر على'التالي'",
            s3:"اختر الموقع الذي تريد حفظ ملفات WAMP فيه. تذكر هذا الموقع وانقر على'التالي'",
            s4:"استمر في النقر على'التالي' حتى يتم تثبيت خادم WAMP",
            Instdzssel:"6- تثبيت  Dz SELL ",
            inst1:"قم بتشغيل الملف Dz sell.exe قم بالمصادقة على الاذن بالضغط على Ok ثم سيظهر المثبت قم بالضغط على   التالي ، التالي ... حتى تصل الى الجزء الخاص بالملفات قم بتثبيته في ملف www الخاص بـ  Wamp server مثال : C:/wamp64/www/Dzsell وبعدها اتمم بالنقر على التالي ",
            startwmp:"7- قم بتشغيل WAMP server  ",
            wampgd:"اتجه نحو الايقونة الخضراء ذات الحرف W فكل العمل سيتم هناك ",
            php:"8- إعداد وتجهيز php ",
            phpcon:"اضغط على الأيقونة الخضراء وقم بالتوجه نحو php version واختار الإصدار رقم 7.4.33",
            phpadm:"9- الوصول إلى phpmyadmin",
            phpadmin:"اضغط على الأيقونة الخضراء ثم اتجه نحو phpmyadmin وانقر عليها ، بعدها سيتم فتح نافذة جديدة في المتصفح .",
            dbc:"10- إنشاء قاعدة البيانات ",
            db:"قم بتسجيل الدخول إلى phpmyadmin بوضع 'root ' كاسم المستخدم مع ابقاء كلمة السر فارغة ثم توجه نحو قواعد البيانات وقم بإنشاء قاعدة بيانات جديدة باسم dzsell ",
            dbimp:"11- استيراد قاعدة البيانات ",
            imp:"اضغط على 'import' ثم 'Browse'. انتقل إلى هذا المسار: C:\wamp64\www\Dz SELL\databases\dzsell.sql. قم بالتمرير لأسفل وانقر على''import'. انتظر بضع ثوان ، سترى رسالة تأكيد.",
            virtual:"12- إنشاء الإستضافة الافتراضية",
       grW:"توجه نحو الأيقونة الخضراء الخاصة بالسيرفر وإنقر على local host ثم اختر add a virtualhost",
       
            
            vh:"13- إعداد الإستضافة الافتراضية ",

            f1:"املأ الإدخال الأول بأي عبارة تريد ك www.dzsell.com أو pos او dzsell",
            f2:"قم بنسخ مكان تخزين  Dz SELL وملاأ الإدخال الثاني مثال : C:/wamp64/www/DzSELL  ",
            f3:"اترك الإدخال الثالث فارغا ",
    ...
    dzselll:"Dz SELL it self",
        ...
        a3:" sure thing , Our POS softare is able to handle data importing and exporting with MS excel or any woorsheet and also can export data in many formats like PDF , SQL , xlsx ...",
        4:"does Dz SELL copatible with diffrent brands of barcode scanners and printers ?",
        a4:" Yes , Dz SELL is compatible with ALL brands of barcode scanners and thermal printers",
        6 :"what does Dz SELL use as a database ?", 
        a6:"Dz SELL use mysql as a database wich is provided by the WAMP server . ", 
        ...
        pre:"the required files from our website. These will include the following:",
           ...
           dzs:"2. Purchase Dz SELL and Download",
           or1:"Purchase Dz SELL from our website or",
           or2:"d obtain the download link. Download the Dz SELL package",
           ...
           Instdzssel:"6- Install Dz SELL",
           inst1:" installer. A window will pop up. Click 'OK'. The installer will prompt you for a location to save the Dz SELL files. Install it in the 'www' folder of your WAMP server (e.g., C:\wamp64\www\Dz SELL). If you are installing it on the C drive, you can just click 'Next' as the default path should be correct ",
           startwmp:"7. Start WAMP Server",
            ...
            dbc:"10- Create the Dz SELL Database",
            db:"Enter the username ''root'' (without a password). In the ''Databases'' section, click ''New'' to create a new database. Name it ''dzsell''. This will create a database named ''dzsell''.",
            dbimp:"11- Import the Database",
            imp:"Click on 'Import' and then 'Browse'. Go to this path: C:\wamp64\www\Dz SELL\databases\dzsell.sql. Scroll down and click 'Import'. Wait for a few seconds, and you will see a confirmation message.",
